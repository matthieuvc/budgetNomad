...
class CookersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cooker" do
    assert_difference("Cooker.count") do
      post cookers_url, params: { cooker: { address: @cooker.address, description: @cooker.description, name: @cooker.name, rating: @cooker.rating, type_cook: @cooker.type_cook } }
    end
  ...
  test "should update cooker" do
    patch cooker_url(@cooker), params: { cooker: { address: @cooker.address, description: @cooker.description, name: @cooker.name, rating: @cooker.rating, type_cook: @cooker.type_cook } }
